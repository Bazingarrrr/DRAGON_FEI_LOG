...
void first_ini(){
	...
	stage_title_count[1] = 3200;
	stage_title_count[2] = 5200;
	stage_title_count[3] = 5600;
	stage_title_count[4] = 8200;
...
int boss_hp[DANMAKU_MAX]={
	1000,2000,3000,10000,12500,17500,25000,30000,40000,
};
/*ここまで*/
...
//	boss.appear_count[0]=1700;//中ボスが出現する時刻(42)
	boss.appear_count[0]=5450;//中ボスが出現する時刻(42)(47)
	boss.appear_count[1]=8450;//最後ボスが出現する時刻(44)(47)

	boss.danmaku_num[0]=2;//中ボスが何個目までの弾幕を出すか
	boss.danmaku_num[1]=8;//最後に出るボスが何個目までの弾幕を出すか(47)
